Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/stoneioslife/MWPhotoBrowser_NgariDoctor'
  s.author = { 'stoneioslife' => 'lintao.stone@gmail.com' }
  s.social_media_url = 'https://github.com/stoneioslife'
